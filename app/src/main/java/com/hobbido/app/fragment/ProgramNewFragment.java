...
public class ProgramNewFragment extends Fragment {
    RecyclerView recyclerView;
    Activity activity;

    public ProgramNewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_program_new, container, false);
    }
    @Override
    ...
    public void setDataOnCategoryList() {
        ...
        ProgramNewAdapter adapter = new ProgramNewAdapter(activity, arrayList,this);
        LinearLayoutManager layoutManager = new LinearLayoutManager(activity);
        layoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(adapter);
    }
    public void dispatchToDetailsNewActivity(){
