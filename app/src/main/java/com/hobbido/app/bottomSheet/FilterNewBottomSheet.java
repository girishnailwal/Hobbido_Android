...
public class FilterNewBottomSheet extends BottomSheetDialogFragment implements View.OnClickListener {

    public static final String TAG = "ActionBottomDialog";

    private ItemClickListener mListener;

    public static FilterNewBottomSheet newInstance() {
        return new FilterNewBottomSheet();
    }
