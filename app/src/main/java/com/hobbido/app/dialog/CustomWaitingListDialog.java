...
public class CustomWaitingListDialog extends Dialog implements View.OnClickListener{
    ...
    public CustomWaitingListDialog(Context context, DialogButtonListenerWithText listener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_waiting_list_dialog);
